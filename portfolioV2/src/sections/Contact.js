    ...
    <div className="flex h-[400px]">
      ...
      <div className="w-1/4 p-8 bg-primary">
        ...
        <p className="text-sm text-white">
          ...
          creating better societies using AI, data and product strategy.
        </p>
        <button className="my-8 text-white text-sm border border-white font-bold text-primary text-sm rounded-full py-2 px-10 uppercase">
          view resume
        </button>
      </div>
